...
- 🛰️ [agent-lsp](https://github.com/blackwell-systems/agent-lsp) - Orchestrates language servers (gopls, rust-analyzer, pyright, etc.) into agent-native workflows. 65 code intelligence tools, 30 CI-verified languages, speculative editing, and token-optimized output. Single Go binary.
